...
> **Note:** The SHA256 conversion method used in generating the digest byte will also prove significant in the [Exchange authorization code for access tokens]() section
